...
* **Gravação:** [recording-client.js](file:///e:/Projetos/Trabalho/Screen%20Share/src/shared/recording-client.js) — Manipula o envio de chunks de gravação (`MediaRecorder`) via API POST para o servidor.

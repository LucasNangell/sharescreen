(() => {
  ...
  function hasVideoAvailable(c) {
    var _a42;
    return !!((c == null ? void 0 : c.isProducing) || (c == null ? void 0 : c.hasVideo) || ((_a42 = c == null ? void 0 : c.producerIds) == null ? void 0 : _a42.video));
  }
  ...
  async function runTransmission(raw, gen = transmissionGeneration) {
    ...
    try {
      if (!tx.producerId) {
        ...
        if (!tx.paused) {
          try {
            await ((_b = (_a42 = els.preview) == null ? void 0 : _a42.play) == null ? void 0 : _b.call(_a42));
          } catch (_) {
          }
        }
      }
  ...
  async function applyRoomSnapshot(snapshot, { force = false } = {}) {
    ...
    if (!hostReady || joinInProgress) {
      ...
      if (((_a42 = snapshot.clients) == null ? void 0 : _a42.length) || ((_b = parsed.peers) == null ? void 0 : _b.length)) {
        estado = {
  ...
  function getRecordingStream() {
    var _a42, _b, _c, _d, _e;
    const selectedPeerId = (_a42 = estado.selecionado) == null ? void 0 : _a42.id;
  ...
  function handleMessage(msg) {
    var _a42, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k;
...
${entry.technical}`;
  ...
  (_a9 = els.btnRecordingToggle) == null ? void 0 : _a9.addEventListener("click", () => {
    ...
    if (ui._flags.isRecording) {
      (_a42 = els.btnPararGravar) == null ? void 0 : _a42.click();
    } else {

(() => {
      ...
      function getExtendedRtpCapabilities(localCaps, remoteCaps, preferLocalCodecsOrder) {
        ...
        for (const extendedCodec of extendedRtpCapabilities.codecs) {
          const matchingLocalRtxCodec = localCaps.codecs.find((localCodec) => {
            var _a46;
            return isRtxCodec(localCodec) && ((_a46 = localCodec.parameters) == null ? void 0 : _a46["apt"]) === extendedCodec.localPayloadType;
          });
          const matchingRemoteRtxCodec = remoteCaps.codecs.find((remoteCodec) => {
            var _a46;
            return isRtxCodec(remoteCodec) && ((_a46 = remoteCodec.parameters) == null ? void 0 : _a46["apt"]) === extendedCodec.remotePayloadType;
          });
      ...
      var DataProducer = class extends enhancedEvents_1.EnhancedEventEmitter {
        ...
        handleDataChannel() {
          ...
          this._dataChannel.addEventListener("error", (event) => {
            ...
            if (((_a46 = event.error) == null ? void 0 : _a46.errorDetail) === "sctp-failure") {
    ...
    "node_modules/mediasoup-client/lib/handlers/sdp/MediaSection.js"(exports) {
      ...
      var AnswerMediaSection = class extends MediaSection {
        ...
        muxSimulcastStreams(encodings) {
          var _a46, _b;
          if (!((_a46 = this._mediaObject.simulcast) == null ? void 0 : _a46.list1)) {
            return;
          }
          const layers = {};
        ...
        constructor({ iceParameters, iceCandidates, dtlsParameters, sctpParameters, plainRtpParameters, mid, kind, offerRtpParameters, streamId, trackId }) {
          ...
          switch (kind) {
            ...
            case "video": {
              ...
              const rtxSsrc = (_a46 = encoding.rtx) == null ? void 0 : _a46.ssrc;
    ...
    "node_modules/mediasoup-client/lib/handlers/sdp/RemoteSdp.js"(exports) {
      ...
      var RemoteSdp = class {
        ...
        send({ offerMediaObject, reuseMid, offerRtpParameters, answerRtpParameters, codecOptions }) {
          ...
          if (!ddCodec) {
            mediaObject.ext = (_a46 = mediaObject.ext) == null ? void 0 : _a46.filter((extmap) => extmap.uri !== "https://aomediacodec.github.io/av1-rtp-spec/#dependency-descriptor-rtp-header-extension");
          }
          if (reuseMid) {
    ...
    "node_modules/mediasoup-client/lib/handlers/sdp/commonUtils.js"(exports) {
      ...
      function applyCodecParameters({ offerRtpParameters, answerMediaObject }) {
        ...
        for (const codec of offerRtpParameters.codecs) {
          ...
          switch (mimeType) {
            case "audio/opus": {
              const spropStereo = (_a46 = codec.parameters) == null ? void 0 : _a46["sprop-stereo"];
    ...
    "node_modules/mediasoup-client/lib/handlers/ortc/utils.js"(exports) {
      ...
      function addNackSupportForOpus(rtpCapabilities) {
        ...
        for (const codec of rtpCapabilities.codecs ?? []) {
          if ((codec.mimeType.toLowerCase() === "audio/opus" || codec.mimeType.toLowerCase() === "audio/multiopus") && !((_a46 = codec.rtcpFeedback) == null ? void 0 : _a46.some((fb) => fb.type === "nack" && !fb.parameter))) {
      ...
      function addHeaderExtensionSupport(rtpCapabilities, headerExtension) {
        var _a46;
        let preferredId;
        const existingHeaderExtension = (_a46 = rtpCapabilities.headerExtensions) == null ? void 0 : _a46.find((exten) => exten.uri === headerExtension.uri);
  ...
  var require_Chrome111 = __commonJS({
    "node_modules/mediasoup-client/lib/handlers/Chrome111.js"(exports) {
      ...
      var Chrome111 = class _Chrome111 extends enhancedEvents_1.EnhancedEventEmitter {
        ...
        async receive(optionsList) {
          ...
          for (const options of optionsList) {
            ...
            this._remoteSdp.receive({
              ...
              streamId: streamId ?? msidStreamId ?? ((_a46 = rtpParameters.rtcp) == null ? void 0 : _a46.cname) ?? "-",
              trackId
            });
          }
          const offer = {
        ...
        getDataChannelMaxMessageSize() {
          var _a46;
          return (_a46 = this._pc.sctp) == null ? void 0 : _a46.maxMessageSize;
        }
  ...
  var SignalingClient = class {
    ...
    get connected() {
      var _a46;
      return ((_a46 = this.ws) == null ? void 0 : _a46.readyState) === WebSocket.OPEN;
    }
    setState(next) {
      ...
      return new Promise((resolve, reject) => {
        ...
        const entry = {
          ...
          filter: (msg) => {
            ...
            if (msg.type === "erro") {
              clearTimeout(timer);
              reject(new Error(((_a46 = msg.payload) == null ? void 0 : _a46.mensagem) || "Erro do servidor"));
              return true;
            }
    ...
    connect() {
      ...
      socket.onopen = () => {
        ...
        (_a46 = this.onOpen) == null ? void 0 : _a46.call(this);
      };
      socket.onmessage = (ev) => {
        if (this.ws !== socket) return;
        try {
      ...
      socket.onclose = (ev) => {
        ...
        (_a46 = this.onClose) == null ? void 0 : _a46.call(this, this._lastCloseCode, this._lastCloseReason);
  ...
  function pickScreenCodec(device, preferH264 = true) {
    var _a46;
    if (!((_a46 = device == null ? void 0 : device.rtpCapabilities) == null ? void 0 : _a46.codecs)) return null;
  ...
  function buildAudioProduceOptions(device, quality = {}) {
    ...
    const opus = (_b = (_a46 = device == null ? void 0 : device.rtpCapabilities) == null ? void 0 : _a46.codecs) == null ? void 0 : _b.find(
    ...
    const pump = async () => {
      ...
      while (!stopped) {
        ...
        try {
          ...
          (_a46 = value == null ? void 0 : value.close) == null ? void 0 : _a46.call(value);
        }
      }
    };
    pump();
  ...
  async function listMicrophoneDevices() {
    ...
    return devices.filter((d) => d.kind === "audioinput" && d.deviceId).map((d, i) => {
      ...
      return {
        deviceId: d.deviceId,
        label: ((_a46 = d.label) == null ? void 0 : _a46.trim()) || `Microfone ${i + 1}`
      };
    });
  }
  ...
  function normalizeRemoteAudioSources(sources, { excludePeerId = null } = {}) {
    ...
    for (const raw of sources || []) {
      ...
      const producerId = (raw == null ? void 0 : raw.producerId) || ((_a46 = raw == null ? void 0 : raw.producerIds) == null ? void 0 : _a46.audio);
  ...
  function closeMicrophoneFilterGraph(graph) {
    ...
    for (const node of graph.nodes || []) {
      try {
        (_a46 = node.disconnect) == null ? void 0 : _a46.call(node);
      } catch (_) {
      }
    }
  ...
  var MediaClient = class {
    ...
    hasPublishedMicrophone() {
      ...
      return !!(producer && !producer.closed && ((_a46 = producer.track) == null ? void 0 : _a46.readyState) === "live");
    }
    ...
    getLocalMicrophoneTrack() {
      var _a46, _b;
      const published = (_a46 = this.producers.microphone) == null ? void 0 : _a46.track;
    ...
    async createTransport(direction, tag = "default") {
      ...
      const createdPromise = this.signaling.onceType(
        ...
        (m) => {
          var _a46, _b;
          return ((_a46 = m.payload) == null ? void 0 : _a46.direction) === direction && (((_b = m.payload) == null ? void 0 : _b.tag) || "default") === recvTag;
        }
      );
      ...
      transport.on("connect", ({ dtlsParameters }, callback, errback) => {
        try {
          const connectedPromise = this.signaling.onceType(
            ...
            (m) => {
              var _a46;
              return ((_a46 = m.payload) == null ? void 0 : _a46.transportId) === transport.id;
            }
          );
      ...
      transport.on("connectionstatechange", (state) => {
        var _a46, _b, _c, _d, _e;
        const level = state === "failed" ? "error" : "info";
        let msg = `Transport ${direction}${recvTag !== "default" ? `/${recvTag}` : ""}: ${state}`;
        if (state === "failed") {
          const ice = ((_a46 = transport.iceCandidates) == null ? void 0 : _a46.map((c) => c.ip).filter(Boolean).join(", ")) || ((_b = this.videoQuality) == null ? void 0 : _b.serverHost) || "?";
        ...
        transport.on("produce", ({ kind, rtpParameters, appData }, callback, errback) => {
          try {
            ...
            const producedPromise = this.signaling.onceType(
              ...
              (m) => {
                var _a46, _b;
                if (((_a46 = m.payload) == null ? void 0 : _a46.kind) !== kind) return false;
    ...
    async _closeAudioProducerBySource(source, { stopMicTrack = false } = {}) {
      ...
      if (producer && !producer.closed) {
        audioTrace("producer fechado", {
          source: key,
          producerId: (_a46 = producer.id) == null ? void 0 : _a46.slice(0, 8)
        });
        producer.close();
      }
    ...
    async _publishAudioTrack(audioTrack, source) {
      ...
      if (existing && !existing.closed && existing.track === audioTrack && ((_a46 = existing.track) == null ? void 0 : _a46.readyState) === "live") {
        return true;
      }
      if (existing && !existing.closed) {
    ...
    async setMicrophoneFilterPrefs(prefs) {
      ...
      if (((_a46 = this.capturePrefs) == null ? void 0 : _a46.microphone) && ((_b = this._micTrack) == null ? void 0 : _b.readyState) === "live") {
    ...
    async publishDisplayStream(displayStream, capturePrefs) {
      ...
      try {
        ...
        const settings = ((_a46 = videoTrack.getSettings) == null ? void 0 : _a46.call(videoTrack)) || {};
    ...
    async _resumeRemoteConsumer(consumer) {
      ...
      if (consumer.kind === "audio" || ((_a46 = consumer.track) == null ? void 0 : _a46.kind) === "audio") {
      ...
      try {
        const resumePromise = this.signaling.onceType(
          ...
          (m) => {
            var _a47;
            return ((_a47 = m.payload) == null ? void 0 : _a47.consumerId) === consumer.id;
          }
        );
    ...
    async _consumeOne(producerId, mediaEl, kindHint, consumerTag = "default") {
      ...
      const payload = await new Promise((resolve, reject) => {
        ...
        const onConsumido = (msg) => {
          ...
          if (((_a46 = msg.payload) == null ? void 0 : _a46.producerId) !== producerId) return;
          cleanup();
          resolve(msg.payload);
        };
        const onErro = (msg) => {
          ...
          const text = String(((_a46 = msg.payload) == null ? void 0 : _a46.mensagem) || "").toLowerCase();
      ...
      return this._runAudioMediaOp(async () => {
        const closeEntry = (key, entry) => {
          ...
          audioTrace("consumer fechado", {
            ...
            source: entrySource,
            consumerId: (_a46 = entry.consumer.id) == null ? void 0 : _a46.slice(0, 8)
          });
    ...
    async consumeAuxiliaryAudio(peerId, producerId, source = "microphone") {
      return this._runAudioMediaOp(async () => {
        ...
        audioTrace("consumer criado", {
          ...
          consumerId: (_a46 = consumer.id) == null ? void 0 : _a46.slice(0, 8)
        });
        return consumer;
      });
    }
      ...
      return this._runVideoMediaOp(async () => {
        ...
        if ((producerIds == null ? void 0 : producerIds.video) && videoEl2) {
          const ownVideoIds = new Set(
            [ownProducerIds == null ? void 0 : ownProducerIds.video, (_a46 = this.producers.video) == null ? void 0 : _a46.id].filter(Boolean)
          );
    ...
    detachMedia({ videoEl: videoEl2 = null, audioEl = null } = {}) {
      ...
      if (audioEl) {
        audioEl.srcObject = null;
        (_a46 = audioEl.pause) == null ? void 0 : _a46.call(audioEl);
      }
    ...
    getRecordableStream({ hostPeerId: hostPeerId2, selectedPeerId } = {}) {
      ...
      const tracks = [];
      const rv = (_a46 = this.remoteConsumers.video) == null ? void 0 : _a46.track;
    ...
    async dispose({ notifyServer = false, keepLocalScreenStream = false, keepMicTrack = false } = {}) {
      ...
      (_a46 = this.sendTransport) == null ? void 0 : _a46.close();
  ...
  function parseRoomSnapshot(snapshot = {}) {
    ...
    const audioSources = snapshot.audioSources || snapshot.audioProducers || ((_a46 = snapshot.fontesAudio) == null ? void 0 : _a46.sources) || [];
    return {
      transmission,
      audioSources,
  ...
  function roomSnapshotMediaKey(snapshot = {}) {
    ...
    const videoId = ((_a46 = transmission.producerIds) == null ? void 0 : _a46.video) || "";
  ...
  function activeVideoTransmissionKey(transmission) {
    ...
    return `${t.selectedPeerId || ""}:${((_a46 = t.producerIds) == null ? void 0 : _a46.video) || ""}:${t.paused ? "1" : "0"}`;
  }
  function remoteVideoConsumeNeeded(transmission, { currentProducerId = null, isSelfSelected = false, hasVideoElement = false, consumerClosed = false } = {}) {
    ...
    const nextId = (_a46 = tx.producerIds) == null ? void 0 : _a46.video;
  ...
  function mergeSourceWithTransmission(source, tx, { isSelected = false } = {}) {
    ...
    const videoId = ((_a46 = normalized.producerIds) == null ? void 0 : _a46.video) || null;
    return {
      ...source,
      isProducing: true,
      hasVideo: true,
  ...
  function enrichRoomSourcesState(estado2 = {}, transmission) {
    ...
    const videoId = (_a46 = tx.producerIds) == null ? void 0 : _a46.video;
    const clients = (estado2.clients || []).map((c) => {
      ...
      if (videoId && (((_a47 = c.producerIds) == null ? void 0 : _a47.video) === videoId || c.producerId === videoId)) {
  ...
  var RecordingClient = class {
    ...
    start(stream, quality = {}) {
      var _a46, _b;
      if (!((_a46 = stream == null ? void 0 : stream.getVideoTracks) == null ? void 0 : _a46.call(stream).length)) {
      ...
      this.mediaRecorder.ondataavailable = (e) => {
        var _a47;
        if (((_a47 = e.data) == null ? void 0 : _a47.size) > 0) {
    ...
    isRecording() {
      var _a46;
      return ((_a46 = this.mediaRecorder) == null ? void 0 : _a46.state) === "recording";
    }
  ...
  function getLiveVideoTrack(stream) {
    var _a46;
    return ((_a46 = stream == null ? void 0 : stream.getVideoTracks) == null ? void 0 : _a46.call(stream).find((track) => track.readyState === "live")) || null;
  }
  function getVideoDimensions(videoEl2, fallbackStream) {
    var _a46;
    const fallbackTrack = getLiveVideoTrack(fallbackStream);
    const settings = ((_a46 = fallbackTrack == null ? void 0 : fallbackTrack.getSettings) == null ? void 0 : _a46.call(fallbackTrack)) || {};
  ...
  function collectOwnAudioTracks(media2, { excludeSystem = false } = {}) {
    var _a46, _b, _c, _d, _e, _f, _g;
    const tracks = [];
    if (!excludeSystem) {
      addTrackOnce(tracks, (_b = (_a46 = media2 == null ? void 0 : media2.producers) == null ? void 0 : _a46.system) == null ? void 0 : _b.track);
  ...
  function collectMonitorAudioTracks(hostAudioMonitor2, mutedClients2, restrictToPeerId = null) {
    ...
    for (const ch of ((_a46 = hostAudioMonitor2.channels) == null ? void 0 : _a46.values()) || []) {
  ...
  var RecordingAudioMixer = {
    async build({
      ...
      var _a46;
      await ((_a46 = hostAudioMonitor2 == null ? void 0 : hostAudioMonitor2.resume) == null ? void 0 : _a46.call(hostAudioMonitor2));
  ...
  async function collectWebRtcStats(mediaClient) {
    ...
    const targets = ((_a46 = mediaClient == null ? void 0 : mediaClient.getStatsTargets) == null ? void 0 : _a46.call(mediaClient)) || [];
  ...
  var HostAudioMonitor = class {
    ...
    countLiveChannelsForPeer(peerId) {
      ...
      for (const ch of this.channels.values()) {
        ...
        const track = (_a46 = ch.consumer) == null ? void 0 : _a46.track;
    ...
    _log(event, data = {}) {
      ...
      (_b = (_a46 = this.opts).onLog) == null ? void 0 : _b.call(_a46, event, data);
    }
    ...
    async _tryPlayOutput() {
      ...
      try {
        ...
        if ((err == null ? void 0 : err.name) === "NotAllowedError" || /autoplay/i.test(String((err == null ? void 0 : err.message) || ""))) {
          ...
          (_b = (_a46 = this.opts).onAutoplayBlocked) == null ? void 0 : _b.call(_a46, err);
        }
      }
    }
    getOutputTrack() {
    ...
    getMixedOutputTrack() {
      ...
      const dspTrack = (_c = (_b = (_a46 = this.dest) == null ? void 0 : _a46.stream) == null ? void 0 : _b.getAudioTracks) == null ? void 0 : _c.call(_b)[0];
    ...
    _startLevelsLoop() {
      ...
      const tick = () => {
        ...
        if (levels.size) (_a46 = this.onLevels) == null ? void 0 : _a46.call(this, levels);
    ...
    _startChannelMeter(ch) {
      var _a46, _b;
      (_a46 = ch.stopMeter) == null ? void 0 : _a46.call(ch);
    ...
    async syncFromSources(sources) {
      ...
      for (const channelKey of [...this.channels.keys()]) {
        ...
        if (isPinned && (ch == null ? void 0 : ch.consumer) && !ch.consumer.closed && ((_a46 = ch.consumer.track) == null ? void 0 : _a46.readyState) === "live") {
          continue;
        }
    ...
    async _addChannel(channelKey, peerId, producerId, source = "microphone", attempt = 0) {
      ...
      try {
        ...
        track.enabled = true;
        await ((_b = (_a46 = this.media)._resumeRemoteConsumer) == null ? void 0 : _b.call(_a46, consumer));
    ...
    async removeByConsumerId(consumerId) {
      ...
      for (const [channelKey, ch] of this.channels.entries()) {
        if (((_a46 = ch.consumer) == null ? void 0 : _a46.id) === consumerId) {
          await this._removeChannel(channelKey);
          return;
        }
      }
  ...
  function hasVideoAvailable(c) {
    var _a46;
    return !!((c == null ? void 0 : c.isProducing) || (c == null ? void 0 : c.hasVideo) || ((_a46 = c == null ? void 0 : c.producerIds) == null ? void 0 : _a46.video) || (c == null ? void 0 : c.producerId) || (c == null ? void 0 : c.status) === "transmitindo");
  }
  ...
  function buildDisplaySourceCard(c, onSelect, options = {}) {
    ...
    (_a46 = options.decorateBody) == null ? void 0 : _a46.call(options, body, c);
  ...
  function readQueryParam(key) {
    var _a46;
    try {
      return ((_a46 = new URLSearchParams(location.search).get(key)) == null ? void 0 : _a46.trim()) || "";
    } catch {
      return "";
    }
  }
  ...
  function resolveRecordingAudioPeer(clients, displayName) {
    ...
    const withAudio = (clients || []).find((c) => {
      ...
      return !!(c.hasAudio || ((_a46 = c.producerIds) == null ? void 0 : _a46.microphone) || ((_b = c.producerIds) == null ? void 0 : _b.system) || ((_c = c.producerIds) == null ? void 0 : _c.audio));
    });
  ...
  function getDefaultHostMicPublishGain() {
    var _a46;
    return Number(((_a46 = media == null ? void 0 : media.videoQuality) == null ? void 0 : _a46.hostMicPublishGain) ?? 1.4);
  }
  ...
  function promptHostEntry(roomPinRequired) {
    return new Promise((resolve) => {
      ...
      const submit = () => {
        var _a47, _b2, _c2, _d;
        const name = ((_a47 = els.hostNameInput) == null ? void 0 : _a47.value.trim()) || "";
        if (!name) {
      ...
      (_a46 = els.hostNameInput) == null ? void 0 : _a46.addEventListener("keydown", (e) => {
        if (e.key === "Enter") {
          e.preventDefault();
          submit();
        }
  ...
  function refreshHostLock() {
    var _a46;
    if (((_a46 = readHostLock()) == null ? void 0 : _a46.tabId) !== HOST_TAB_ID) return;
  ...
  function updateQualityHint() {
    var _a46;
    const preset = getPreset(((_a46 = els.qualityPreset) == null ? void 0 : _a46.value) || loadPresetId());
    if (els.qualityHint) {
  ...
  (_a3 = els.hostMicGainSlider) == null ? void 0 : _a3.addEventListener("input", () => {
    var _a46;
    const gain = Number(((_a46 = els.hostMicGainSlider) == null ? void 0 : _a46.value) || 1.4);
  ...
  (_a4 = els.hostMicGainSlider) == null ? void 0 : _a4.addEventListener("change", () => {
    var _a46;
    applyHostMicPublishGain(Number(((_a46 = els.hostMicGainSlider) == null ? void 0 : _a46.value) || 1.4)).catch(
  ...
  async function onHostAudioPrefsChange() {
    ...
    if (els.hostMicWrap) {
      els.hostMicWrap.hidden = !((_a46 = els.hostChkMic) == null ? void 0 : _a46.checked);
    }
    updateHostMicUi();
  ...
  function log(msg, level = "info") {
    ...
    while (els.logs.children.length > 150) (_a46 = els.logs.lastChild) == null ? void 0 : _a46.remove();
  ...
  function getHostCapturePrefs() {
    var _a46, _b, _c;
    return {
      systemAudio: ((_a46 = els.hostChkSystem) == null ? void 0 : _a46.checked) !== false,
  ...
  function updateHostMicUi() {
    ...
    if (!btn) return;
    const micPublished = (_a46 = media == null ? void 0 : media.hasPublishedMicrophone) == null ? void 0 : _a46.call(media);
  ...
  async function onHostMicClick() {
    ...
    try {
      if (hostMicAutoplayNeeded) {
        ...
        await ((_a46 = els.previewAudio) == null ? void 0 : _a46.play());
  ...
  function syncLocalHostVu() {
    ...
    const track = (_a46 = media == null ? void 0 : media.getLocalAudioTrack) == null ? void 0 : _a46.call(media);
  ...
  function mergeLastAudioSourcesFromEstado(payload = {}) {
    var _a46;
    if ((_a46 = payload.audioSources) == null ? void 0 : _a46.length) {
  ...
  async function syncHostAudioMonitor(sources = null) {
    ...
    syncAudioMonitorPromise = (async () => {
      ...
      do {
        ...
        if (!monitor) return;
        monitor.setMasterVolume(Number(((_a46 = els.volumeSlider) == null ? void 0 : _a46.value) || 100) / 100);
  ...
  function closeFsSourceMenu() {
    ...
    (_a46 = els.btnFsSources) == null ? void 0 : _a46.setAttribute("aria-expanded", "false");
  }
  function toggleFsSourceMenu() {
    ...
    (_a46 = els.btnFsSources) == null ? void 0 : _a46.setAttribute("aria-expanded", String(open));
  }
  ...
  function renderLista() {
    ...
    ui.set({
      ...
      isPaused: !!((_a46 = estado.selecionado) == null ? void 0 : _a46.pausado)
    });
  ...
  async function runTransmission(raw, gen = transmissionGeneration) {
    var _a46, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s;
    ...
    if (tx.selectedPeerId) {
      ...
      if (client) {
        estado.selecionado = {
          ...
          producerIds: {
            ...client.producerIds || {},
            video: ((_a46 = tx.producerIds) == null ? void 0 : _a46.video) || ((_b = client.producerIds) == null ? void 0 : _b.video) || client.producerId || null
          },
  ...
  function shouldHostApplyActiveVideo(tx) {
    ...
    const currentProducerId = (media == null ? void 0 : media.currentActiveVideoProducerId) || ((_b = (_a46 = media == null ? void 0 : media.remoteConsumers) == null ? void 0 : _a46.video) == null ? void 0 : _b.producerId) || null;
  ...
  async function applyRoomSnapshot(snapshot, { force = false } = {}) {
    ...
    debugHostLog("H1", "[ROOM_STATE] snapshot recebido", {
      activeKey,
      producerVideo: ((_c = (_b = (_a46 = parsed.transmission) == null ? void 0 : _a46.producerIds) == null ? void 0 : _b.video) == null ? void 0 : _c.slice(0, 8)) || null,
  ...
  function applyVolumeFromSlider() {
    var _a46;
    const vol = Number(((_a46 = els.volumeSlider) == null ? void 0 : _a46.value) || 100) / 100;
  ...
  function stopRecordingCapture() {
    var _a46;
    (_a46 = recordingCapture == null ? void 0 : recordingCapture.stop) == null ? void 0 : _a46.call(recordingCapture);
    recordingCapture = null;
  }
  function getActiveRecordingSelection() {
    var _a46, _b, _c, _d, _e, _f;
    if ((_a46 = estado.selecionado) == null ? void 0 : _a46.id) return estado.selecionado;
  ...
  async function getRecordingStream() {
    ...
    const videoTrack = (_b = (_a46 = compositor == null ? void 0 : compositor.stream) == null ? void 0 : _a46.getVideoTracks) == null ? void 0 : _b.call(_a46)[0];
    ...
    recordingCapture = {
      ...
      stop() {
        var _a47;
        compositor.stop();
        (_a47 = mixer == null ? void 0 : mixer.stop) == null ? void 0 : _a47.call(mixer);
      }
    };
    return stream;
  }
  function handleMessage(msg) {
    var _a46, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p;
    if (msg.type === "estadoSala") {
      applyRoomSnapshot(msg.payload).catch((e) => errors.handle(e, "estado-sala"));
      return;
    }
    if (msg.type === "clientesSilenciados") {
      const mutedIds = ((_a46 = msg.payload) == null ? void 0 : _a46.mutedPeerIds) || [];
      mutedClients.clear();
    ...
    if (msg.type === "estado") {
      ...
      const videoProducers = (estado.clients || []).filter((c) => {
        var _a47;
        return c.hasVideo || c.isProducing || ((_a47 = c.producerIds) == null ? void 0 : _a47.video);
      }).map((c) => {
        var _a47, _b2, _c2, _d2;
        return {
          peerId: (_a47 = c.id) == null ? void 0 : _a47.slice(0, 8),
...
${entry.technical}`;
  ...
  (_a10 = els.btnPlayPause) == null ? void 0 : _a10.addEventListener("click", () => {
    ...
    if (ui._flags.isPaused) {
      (_a46 = els.btnRetomar) == null ? void 0 : _a46.click();
    } else {
  ...
  function toggleSidebarCollapsed() {
    var _a46, _b, _c, _d, _e, _f;
    const collapsed = !((_a46 = els.sidebar) == null ? void 0 : _a46.classList.contains("is-collapsed"));
  ...
  function openExternalLinkModal() {
    ...
    (_a46 = els.externalGuestName) == null ? void 0 : _a46.focus();
  }
  ...
  async function submitExternalLink() {
    var _a46, _b;
    const nome = ((_a46 = els.externalGuestName) == null ? void 0 : _a46.value.trim()) || "";
    if (!nome) {
      showToast2("Informe o nome do convidado", "warn");
  ...
  (_a23 = els.btnFullscreen) == null ? void 0 : _a23.addEventListener("click", () => {
    ...
    else (_b = (_a46 = els.previewArea) == null ? void 0 : _a46.requestFullscreen) == null ? void 0 : _b.call(_a46);
  });
  var _a24;
  ...
  document.addEventListener("click", (e) => {
    var _a46, _b, _c;
    if ((_a46 = els.fsSourceMenu) == null ? void 0 : _a46.hidden) return;
  ...
  window.addEventListener("sharescreen-ended", async () => {
    ...
    signaling == null ? void 0 : signaling.send("status", {
      status: ((_a46 = media == null ? void 0 : media.hasPublishedMicrophone) == null ? void 0 : _a46.call(media)) ? "transmitindo" : "conectado"
    });
  });
  window.addEventListener("beforeunload", () => {
    clearInterval(hostLockTimer);
  ...
  function setupRecordingAudioPrefs() {
    ...
    syncRecordingAudioPrefsUi();
    syncRecordingDefaultAudioClientUi();
    (_a46 = els.recExcludeOwnSystem) == null ? void 0 : _a46.addEventListener("change", () => {
  ...
  function saveRecordingFilenamePattern() {
    var _a46;
    const pattern = ((_a46 = els.recordingFilenamePatternInput) == null ? void 0 : _a46.value.trim()) || "";
    if (pattern) {
  ...
  function setupRecordingFilenamePattern() {
    ...
    (_a46 = els.btnSaveFilenamePattern) == null ? void 0 : _a46.addEventListener("click", (e) => {
      e.stopPropagation();
  ...
  function setupRecordingsDirInput() {
    ...
    (_a46 = document.getElementById("btn-dir-picker-cancel")) == null ? void 0 : _a46.addEventListener("click", () => {
  ...
  if (isHost) {
    ...
    installAudioUnlock(() => {
      ...
      (_b = (_a46 = els.previewAudio) == null ? void 0 : _a46.play) == null ? void 0 : _b.call(_a46).catch(() => {
      });
  ...
  async function syncPublishedAudioFiltersToClientsAsync(audioSources = []) {
    ...
    for (const source of audioSources || []) {
      ...
      const displayName = (client == null ? void 0 : client.displayName) || source.name || ((_b = (_a46 = monitor.peerNames) == null ? void 0 : _a46.get) == null ? void 0 : _b.call(_a46, id)) || "";
  ...
  function applyAudioFiltersFromUi() {
    var _a46, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m;
    const client = activeAudioFiltersClient;
    const monitor = hostAudioMonitor;
    if (!client || !monitor) return;
    const prefs = {
      gain: Number(((_a46 = $("audio-gain")) == null ? void 0 : _a46.value) !== void 0 ? (_b = $("audio-gain")) == null ? void 0 : _b.value : 1),
  ...
  function initCoHost(clientSignaling, clientMedia, clientPeerId) {
    ...
    hostReady = true;
    if (els.sidebar) els.sidebar.hidden = false;
    (_a46 = els.appMain) == null ? void 0 : _a46.classList.add("sidebar-open");
    updateRecordingUi(RecordingState.IDLE);
    updateMuteButtonIcon();
    setupRecordingsDirInput();
    setupRecordingFilenamePattern();

(() => {
      ...
      function getExtendedRtpCapabilities(localCaps, remoteCaps, preferLocalCodecsOrder) {
        ...
        for (const extendedCodec of extendedRtpCapabilities.codecs) {
          const matchingLocalRtxCodec = localCaps.codecs.find((localCodec) => {
            var _a59;
            return isRtxCodec(localCodec) && ((_a59 = localCodec.parameters) == null ? void 0 : _a59["apt"]) === extendedCodec.localPayloadType;
          });
          const matchingRemoteRtxCodec = remoteCaps.codecs.find((remoteCodec) => {
            var _a59;
            return isRtxCodec(remoteCodec) && ((_a59 = remoteCodec.parameters) == null ? void 0 : _a59["apt"]) === extendedCodec.remotePayloadType;
          });
      ...
      var DataProducer = class extends enhancedEvents_1.EnhancedEventEmitter {
        ...
        handleDataChannel() {
          ...
          this._dataChannel.addEventListener("error", (event) => {
            ...
            if (((_a59 = event.error) == null ? void 0 : _a59.errorDetail) === "sctp-failure") {
    ...
    "node_modules/mediasoup-client/lib/handlers/sdp/MediaSection.js"(exports) {
      ...
      var AnswerMediaSection = class extends MediaSection {
        ...
        muxSimulcastStreams(encodings) {
          var _a59, _b;
          if (!((_a59 = this._mediaObject.simulcast) == null ? void 0 : _a59.list1)) {
            return;
          }
          const layers = {};
        ...
        constructor({ iceParameters, iceCandidates, dtlsParameters, sctpParameters, plainRtpParameters, mid, kind, offerRtpParameters, streamId, trackId }) {
          ...
          switch (kind) {
            ...
            case "video": {
              ...
              const rtxSsrc = (_a59 = encoding.rtx) == null ? void 0 : _a59.ssrc;
    ...
    "node_modules/mediasoup-client/lib/handlers/sdp/RemoteSdp.js"(exports) {
      ...
      var RemoteSdp = class {
        ...
        send({ offerMediaObject, reuseMid, offerRtpParameters, answerRtpParameters, codecOptions }) {
          ...
          if (!ddCodec) {
            mediaObject.ext = (_a59 = mediaObject.ext) == null ? void 0 : _a59.filter((extmap) => extmap.uri !== "https://aomediacodec.github.io/av1-rtp-spec/#dependency-descriptor-rtp-header-extension");
          }
          if (reuseMid) {
    ...
    "node_modules/mediasoup-client/lib/handlers/sdp/commonUtils.js"(exports) {
      ...
      function applyCodecParameters({ offerRtpParameters, answerMediaObject }) {
        ...
        for (const codec of offerRtpParameters.codecs) {
          ...
          switch (mimeType) {
            case "audio/opus": {
              const spropStereo = (_a59 = codec.parameters) == null ? void 0 : _a59["sprop-stereo"];
    ...
    "node_modules/mediasoup-client/lib/handlers/ortc/utils.js"(exports) {
      ...
      function addNackSupportForOpus(rtpCapabilities) {
        ...
        for (const codec of rtpCapabilities.codecs ?? []) {
          if ((codec.mimeType.toLowerCase() === "audio/opus" || codec.mimeType.toLowerCase() === "audio/multiopus") && !((_a59 = codec.rtcpFeedback) == null ? void 0 : _a59.some((fb) => fb.type === "nack" && !fb.parameter))) {
      ...
      function addHeaderExtensionSupport(rtpCapabilities, headerExtension) {
        var _a59;
        let preferredId;
        const existingHeaderExtension = (_a59 = rtpCapabilities.headerExtensions) == null ? void 0 : _a59.find((exten) => exten.uri === headerExtension.uri);
  ...
  var require_Chrome111 = __commonJS({
    "node_modules/mediasoup-client/lib/handlers/Chrome111.js"(exports) {
      ...
      var Chrome111 = class _Chrome111 extends enhancedEvents_1.EnhancedEventEmitter {
        ...
        async receive(optionsList) {
          ...
          for (const options of optionsList) {
            ...
            this._remoteSdp.receive({
              ...
              streamId: streamId ?? msidStreamId ?? ((_a59 = rtpParameters.rtcp) == null ? void 0 : _a59.cname) ?? "-",
              trackId
            });
          }
          const offer = {
        ...
        getDataChannelMaxMessageSize() {
          var _a59;
          return (_a59 = this._pc.sctp) == null ? void 0 : _a59.maxMessageSize;
        }
  ...
  var SignalingClient = class {
    ...
    get connected() {
      var _a59;
      return ((_a59 = this.ws) == null ? void 0 : _a59.readyState) === WebSocket.OPEN;
    }
    setState(next) {
      ...
      return new Promise((resolve, reject) => {
        ...
        const entry = {
          ...
          filter: (msg) => {
            ...
            if (msg.type === "erro") {
              clearTimeout(timer);
              reject(new Error(((_a59 = msg.payload) == null ? void 0 : _a59.mensagem) || "Erro do servidor"));
              return true;
            }
    ...
    connect() {
      ...
      socket.onopen = () => {
        ...
        (_a59 = this.onOpen) == null ? void 0 : _a59.call(this);
      };
      socket.onmessage = (ev) => {
        if (this.ws !== socket) return;
        try {
      ...
      socket.onclose = (ev) => {
        ...
        (_a59 = this.onClose) == null ? void 0 : _a59.call(this, this._lastCloseCode, this._lastCloseReason);
  ...
  function pickScreenCodec(device, preferH264 = true) {
    var _a59;
    if (!((_a59 = device == null ? void 0 : device.rtpCapabilities) == null ? void 0 : _a59.codecs)) return null;
  ...
  function buildAudioProduceOptions(device, quality = {}) {
    ...
    const opus = (_b = (_a59 = device == null ? void 0 : device.rtpCapabilities) == null ? void 0 : _a59.codecs) == null ? void 0 : _b.find(
    ...
    const pump = async () => {
      ...
      while (!stopped) {
        ...
        try {
          ...
          (_a59 = value == null ? void 0 : value.close) == null ? void 0 : _a59.call(value);
        }
      }
    };
    pump();
  ...
  async function listMicrophoneDevices() {
    ...
    return devices.filter((d) => d.kind === "audioinput" && d.deviceId).map((d, i) => {
      ...
      return {
        deviceId: d.deviceId,
        label: ((_a59 = d.label) == null ? void 0 : _a59.trim()) || `Microfone ${i + 1}`
      };
    });
  }
  ...
  var VuMeter = class {
    ...
    attach(track, onLevel) {
      ...
      this.stopMeter = startTrackLevelMeter(track, {
        onLevel: (smoothed) => {
          ...
          (_a59 = this.onLevel) == null ? void 0 : _a59.call(this, this.level);
        }
      });
    }
    async resume() {
    ...
    detach() {
      var _a59;
      (_a59 = this.stopMeter) == null ? void 0 : _a59.call(this);
      this.stopMeter = null;
      this.level = 0;
    }
  };
  ...
  function normalizeRemoteAudioSources(sources, { excludePeerId = null } = {}) {
    ...
    for (const raw of sources || []) {
      ...
      const producerId = (raw == null ? void 0 : raw.producerId) || ((_a59 = raw == null ? void 0 : raw.producerIds) == null ? void 0 : _a59.audio);
  ...
  function closeMicrophoneFilterGraph(graph) {
    ...
    for (const node of graph.nodes || []) {
      try {
        (_a59 = node.disconnect) == null ? void 0 : _a59.call(node);
      } catch (_) {
      }
    }
  ...
  var MediaClient = class {
    ...
    hasPublishedMicrophone() {
      ...
      return !!(producer && !producer.closed && ((_a59 = producer.track) == null ? void 0 : _a59.readyState) === "live");
    }
    ...
    getLocalMicrophoneTrack() {
      var _a59, _b;
      const published = (_a59 = this.producers.microphone) == null ? void 0 : _a59.track;
    ...
    async createTransport(direction, tag = "default") {
      ...
      const createdPromise = this.signaling.onceType(
        ...
        (m) => {
          var _a59, _b;
          return ((_a59 = m.payload) == null ? void 0 : _a59.direction) === direction && (((_b = m.payload) == null ? void 0 : _b.tag) || "default") === recvTag;
        }
      );
      ...
      transport.on("connect", ({ dtlsParameters }, callback, errback) => {
        try {
          const connectedPromise = this.signaling.onceType(
            ...
            (m) => {
              var _a59;
              return ((_a59 = m.payload) == null ? void 0 : _a59.transportId) === transport.id;
            }
          );
      ...
      transport.on("connectionstatechange", (state) => {
        ...
        if (state === "failed") {
          const ice = ((_a59 = transport.iceCandidates) == null ? void 0 : _a59.map((c) => c.ip).filter(Boolean).join(", ")) || ((_b = this.videoQuality) == null ? void 0 : _b.serverHost) || "?";
        ...
        transport.on("produce", ({ kind, rtpParameters, appData }, callback, errback) => {
          try {
            ...
            const producedPromise = this.signaling.onceType(
              ...
              (m) => {
                var _a59, _b;
                if (((_a59 = m.payload) == null ? void 0 : _a59.kind) !== kind) return false;
    ...
    async _closeAudioProducerBySource(source, { stopMicTrack = false } = {}) {
      ...
      if (producer && !producer.closed) {
        audioTrace("producer fechado", {
          source: key,
          producerId: (_a59 = producer.id) == null ? void 0 : _a59.slice(0, 8)
        });
        producer.close();
      }
    ...
    async _publishAudioTrack(audioTrack, source) {
      ...
      if (existing && !existing.closed && existing.track === audioTrack && ((_a59 = existing.track) == null ? void 0 : _a59.readyState) === "live") {
        return true;
      }
      if (existing && !existing.closed) {
    ...
    async setMicrophoneFilterPrefs(prefs) {
      ...
      if (((_a59 = this.capturePrefs) == null ? void 0 : _a59.microphone) && ((_b = this._micTrack) == null ? void 0 : _b.readyState) === "live") {
    ...
    async publishDisplayStream(displayStream, capturePrefs2) {
      ...
      try {
        ...
        const settings = ((_a59 = videoTrack.getSettings) == null ? void 0 : _a59.call(videoTrack)) || {};
    ...
    async _resumeRemoteConsumer(consumer) {
      ...
      if (consumer.kind === "audio" || ((_a59 = consumer.track) == null ? void 0 : _a59.kind) === "audio") {
      ...
      try {
        const resumePromise = this.signaling.onceType(
          ...
          (m) => {
            var _a60;
            return ((_a60 = m.payload) == null ? void 0 : _a60.consumerId) === consumer.id;
          }
        );
    ...
    async _consumeOne(producerId, mediaEl, kindHint, consumerTag = "default") {
      ...
      const payload = await new Promise((resolve, reject) => {
        ...
        const onConsumido = (msg) => {
          ...
          if (((_a59 = msg.payload) == null ? void 0 : _a59.producerId) !== producerId) return;
          cleanup();
          resolve(msg.payload);
        };
        const onErro = (msg) => {
          ...
          const text = String(((_a59 = msg.payload) == null ? void 0 : _a59.mensagem) || "").toLowerCase();
      ...
      return this._runAudioMediaOp(async () => {
        const closeEntry = (key, entry) => {
          ...
          audioTrace("consumer fechado", {
            ...
            source: entrySource,
            consumerId: (_a59 = entry.consumer.id) == null ? void 0 : _a59.slice(0, 8)
          });
    ...
    async consumeAuxiliaryAudio(peerId2, producerId, source = "microphone") {
      return this._runAudioMediaOp(async () => {
        ...
        audioTrace("consumer criado", {
          ...
          consumerId: (_a59 = consumer.id) == null ? void 0 : _a59.slice(0, 8)
        });
        return consumer;
      });
    }
      ...
      return this._runVideoMediaOp(async () => {
        ...
        if ((producerIds == null ? void 0 : producerIds.video) && videoEl2) {
          const ownVideoIds = new Set(
            [ownProducerIds == null ? void 0 : ownProducerIds.video, (_a59 = this.producers.video) == null ? void 0 : _a59.id].filter(Boolean)
          );
    ...
    detachMedia({ videoEl: videoEl2 = null, audioEl = null } = {}) {
      ...
      if (audioEl) {
        audioEl.srcObject = null;
        (_a59 = audioEl.pause) == null ? void 0 : _a59.call(audioEl);
      }
    ...
    getRecordableStream({ hostPeerId: hostPeerId3, selectedPeerId } = {}) {
      ...
      const tracks = [];
      const rv = (_a59 = this.remoteConsumers.video) == null ? void 0 : _a59.track;
    ...
    async dispose({ notifyServer = false, keepLocalScreenStream = false, keepMicTrack = false } = {}) {
      ...
      (_a59 = this.sendTransport) == null ? void 0 : _a59.close();
  ...
  function parseRoomSnapshot(snapshot = {}) {
    ...
    const audioSources = snapshot.audioSources || snapshot.audioProducers || ((_a59 = snapshot.fontesAudio) == null ? void 0 : _a59.sources) || [];
    return {
      transmission,
      audioSources,
  ...
  function roomSnapshotMediaKey(snapshot = {}) {
    ...
    const videoId = ((_a59 = transmission.producerIds) == null ? void 0 : _a59.video) || "";
  ...
  function activeVideoTransmissionKey(transmission) {
    ...
    return `${t.selectedPeerId || ""}:${((_a59 = t.producerIds) == null ? void 0 : _a59.video) || ""}:${t.paused ? "1" : "0"}`;
  }
  function remoteVideoConsumeNeeded(transmission, { currentProducerId = null, isSelfSelected = false, hasVideoElement = false, consumerClosed = false } = {}) {
    ...
    const nextId = (_a59 = tx.producerIds) == null ? void 0 : _a59.video;
  ...
  function mergeSourceWithTransmission(source, tx, { isSelected = false } = {}) {
    ...
    const videoId = ((_a59 = normalized.producerIds) == null ? void 0 : _a59.video) || null;
    return {
      ...source,
      isProducing: true,
      hasVideo: true,
  ...
  function enrichRoomSourcesState(estado2 = {}, transmission) {
    ...
    const videoId = (_a59 = tx.producerIds) == null ? void 0 : _a59.video;
    const clients = (estado2.clients || []).map((c) => {
      ...
      if (videoId && (((_a60 = c.producerIds) == null ? void 0 : _a60.video) === videoId || c.producerId === videoId)) {
  ...
  function enrichDisplaySources(sources, transmission) {
    ...
    return sources.map((s) => {
      ...
      if (videoId && (((_a60 = s.producerIds) == null ? void 0 : _a60.video) === videoId || s.producerId === videoId)) {
  ...
  function transmissionSelectionKey(tx) {
    ...
    return [
      n.selectedPeerId || "",
      ((_a59 = n.producerIds) == null ? void 0 : _a59.video) || "",
      n.paused ? "1" : "0"
    ].join(":");
  }
  var TransmissionSync = class {
    ...
    _needsVideoSync(tx, force) {
      ...
      const currentProducerId = media3.currentActiveVideoProducerId || ((_b = (_a59 = media3.remoteConsumers) == null ? void 0 : _a59.video) == null ? void 0 : _b.producerId) || null;
    ...
    apply(rawTx, { force = false } = {}) {
      ...
      this._work = this._work.then(() => this._runApply(tx, gen)).catch((e) => {
        var _a59;
        (_a59 = this.onError) == null ? void 0 : _a59.call(this, e);
        throw e;
      });
      return this._work;
    }
    onConsumerClosed(consumerId) {
      ...
      const wasVideoConsumer = ((_b = (_a59 = media3.remoteConsumers) == null ? void 0 : _a59.video) == null ? void 0 : _b.id) === consumerId;
      if (wasVideoConsumer) {
    ...
    async _runApply(tx, gen) {
      var _a59, _b, _c, _d, _e, _f, _g, _h, _i;
      ...
      try {
        ...
        if (isSelectedSelf && !tx.paused) {
          ...
          const nextVideoProducer = (_a59 = tx.producerIds) == null ? void 0 : _a59.video;
  ...
  var HostAudioMonitor = class {
    ...
    countLiveChannelsForPeer(peerId2) {
      ...
      for (const ch of this.channels.values()) {
        ...
        const track = (_a59 = ch.consumer) == null ? void 0 : _a59.track;
    ...
    _log(event, data = {}) {
      ...
      (_b = (_a59 = this.opts).onLog) == null ? void 0 : _b.call(_a59, event, data);
    }
    ...
    async _tryPlayOutput() {
      ...
      try {
        ...
        if ((err == null ? void 0 : err.name) === "NotAllowedError" || /autoplay/i.test(String((err == null ? void 0 : err.message) || ""))) {
          ...
          (_b = (_a59 = this.opts).onAutoplayBlocked) == null ? void 0 : _b.call(_a59, err);
        }
      }
    }
    getOutputTrack() {
    ...
    getMixedOutputTrack() {
      ...
      const dspTrack = (_c = (_b = (_a59 = this.dest) == null ? void 0 : _a59.stream) == null ? void 0 : _b.getAudioTracks) == null ? void 0 : _c.call(_b)[0];
    ...
    _startLevelsLoop() {
      ...
      const tick = () => {
        ...
        if (levels.size) (_a59 = this.onLevels) == null ? void 0 : _a59.call(this, levels);
    ...
    _startChannelMeter(ch) {
      var _a59, _b;
      (_a59 = ch.stopMeter) == null ? void 0 : _a59.call(ch);
    ...
    async syncFromSources(sources) {
      ...
      for (const channelKey of [...this.channels.keys()]) {
        ...
        if (isPinned && (ch == null ? void 0 : ch.consumer) && !ch.consumer.closed && ((_a59 = ch.consumer.track) == null ? void 0 : _a59.readyState) === "live") {
          continue;
        }
    ...
    async _addChannel(channelKey, peerId2, producerId, source = "microphone", attempt = 0) {
      ...
      try {
        ...
        track.enabled = true;
        await ((_b = (_a59 = this.media)._resumeRemoteConsumer) == null ? void 0 : _b.call(_a59, consumer));
    ...
    async removeByConsumerId(consumerId) {
      ...
      for (const [channelKey, ch] of this.channels.entries()) {
        if (((_a59 = ch.consumer) == null ? void 0 : _a59.id) === consumerId) {
          await this._removeChannel(channelKey);
          return;
        }
      }
  ...
  function isSelectableSource(client) {
    var _a59;
    return !!((client == null ? void 0 : client.isProducing) || (client == null ? void 0 : client.hasVideo) || ((_a59 = client == null ? void 0 : client.producerIds) == null ? void 0 : _a59.video) || (client == null ? void 0 : client.producerId) || (client == null ? void 0 : client.status) === "transmitindo");
  }
  ...
  function hasVideoAvailable(c) {
    var _a59;
    return !!((c == null ? void 0 : c.isProducing) || (c == null ? void 0 : c.hasVideo) || ((_a59 = c == null ? void 0 : c.producerIds) == null ? void 0 : _a59.video) || (c == null ? void 0 : c.producerId) || (c == null ? void 0 : c.status) === "transmitindo");
  }
  ...
  function buildDisplaySourceCard(c, onSelect, options = {}) {
    ...
    (_a59 = options.decorateBody) == null ? void 0 : _a59.call(options, body, c);
  ...
  var RecordingClient = class {
    ...
    start(stream, quality = {}) {
      var _a59, _b;
      if (!((_a59 = stream == null ? void 0 : stream.getVideoTracks) == null ? void 0 : _a59.call(stream).length)) {
      ...
      this.mediaRecorder.ondataavailable = (e) => {
        var _a60;
        if (((_a60 = e.data) == null ? void 0 : _a60.size) > 0) {
    ...
    isRecording() {
      var _a59;
      return ((_a59 = this.mediaRecorder) == null ? void 0 : _a59.state) === "recording";
    }
  ...
  function getLiveVideoTrack(stream) {
    var _a59;
    return ((_a59 = stream == null ? void 0 : stream.getVideoTracks) == null ? void 0 : _a59.call(stream).find((track) => track.readyState === "live")) || null;
  }
  function getVideoDimensions(videoEl2, fallbackStream) {
    var _a59;
    const fallbackTrack = getLiveVideoTrack(fallbackStream);
    const settings = ((_a59 = fallbackTrack == null ? void 0 : fallbackTrack.getSettings) == null ? void 0 : _a59.call(fallbackTrack)) || {};
  ...
  function collectOwnAudioTracks(media3, { excludeSystem = false } = {}) {
    var _a59, _b, _c, _d, _e, _f, _g;
    const tracks = [];
    if (!excludeSystem) {
      addTrackOnce(tracks, (_b = (_a59 = media3 == null ? void 0 : media3.producers) == null ? void 0 : _a59.system) == null ? void 0 : _b.track);
  ...
  function collectMonitorAudioTracks(hostAudioMonitor2, mutedClients3, restrictToPeerId = null) {
    ...
    for (const ch of ((_a59 = hostAudioMonitor2.channels) == null ? void 0 : _a59.values()) || []) {
  ...
  var RecordingAudioMixer = {
    async build({
      ...
      var _a59;
      await ((_a59 = hostAudioMonitor2 == null ? void 0 : hostAudioMonitor2.resume) == null ? void 0 : _a59.call(hostAudioMonitor2));
  ...
  async function collectWebRtcStats(mediaClient) {
    ...
    const targets = ((_a59 = mediaClient == null ? void 0 : mediaClient.getStatsTargets) == null ? void 0 : _a59.call(mediaClient)) || [];
  ...
  function readQueryParam(key) {
    var _a59;
    try {
      return ((_a59 = new URLSearchParams(location.search).get(key)) == null ? void 0 : _a59.trim()) || "";
    } catch {
      return "";
    }
  }
  ...
  function resolveRecordingAudioPeer(clients, displayName2) {
    ...
    const withAudio = (clients || []).find((c) => {
      ...
      return !!(c.hasAudio || ((_a59 = c.producerIds) == null ? void 0 : _a59.microphone) || ((_b = c.producerIds) == null ? void 0 : _b.system) || ((_c = c.producerIds) == null ? void 0 : _c.audio));
    });
  ...
  function getDefaultHostMicPublishGain() {
    var _a59;
    return Number(((_a59 = media == null ? void 0 : media.videoQuality) == null ? void 0 : _a59.hostMicPublishGain) ?? 1.4);
  }
  ...
  function promptHostEntry(roomPinRequired) {
    return new Promise((resolve) => {
      ...
      const submit = () => {
        var _a60, _b2, _c2, _d;
        const name = ((_a60 = els.hostNameInput) == null ? void 0 : _a60.value.trim()) || "";
        if (!name) {
      ...
      (_a59 = els.hostNameInput) == null ? void 0 : _a59.addEventListener("keydown", (e) => {
        if (e.key === "Enter") {
          e.preventDefault();
          submit();
        }
  ...
  function refreshHostLock() {
    var _a59;
    if (((_a59 = readHostLock()) == null ? void 0 : _a59.tabId) !== HOST_TAB_ID) return;
  ...
  function updateQualityHint() {
    var _a59;
    const preset = getPreset(((_a59 = els.qualityPreset) == null ? void 0 : _a59.value) || loadPresetId());
    if (els.qualityHint) {
  ...
  (_a3 = els.hostMicGainSlider) == null ? void 0 : _a3.addEventListener("input", () => {
    var _a59;
    const gain = Number(((_a59 = els.hostMicGainSlider) == null ? void 0 : _a59.value) || 1.4);
  ...
  (_a4 = els.hostMicGainSlider) == null ? void 0 : _a4.addEventListener("change", () => {
    var _a59;
    applyHostMicPublishGain(Number(((_a59 = els.hostMicGainSlider) == null ? void 0 : _a59.value) || 1.4)).catch(
  ...
  async function onHostAudioPrefsChange() {
    ...
    if (els.hostMicWrap) {
      els.hostMicWrap.hidden = !((_a59 = els.hostChkMic) == null ? void 0 : _a59.checked);
    }
    updateHostMicUi();
  ...
  function log(msg, level = "info") {
    ...
    while (els.logs.children.length > 150) (_a59 = els.logs.lastChild) == null ? void 0 : _a59.remove();
  ...
  function getHostCapturePrefs() {
    var _a59, _b, _c;
    return {
      systemAudio: ((_a59 = els.hostChkSystem) == null ? void 0 : _a59.checked) !== false,
  ...
  function updateHostMicUi() {
    ...
    if (!btn) return;
    const micPublished = (_a59 = media == null ? void 0 : media.hasPublishedMicrophone) == null ? void 0 : _a59.call(media);
  ...
  async function onHostMicClick() {
    ...
    try {
      if (hostMicAutoplayNeeded) {
        ...
        await ((_a59 = els.previewAudio) == null ? void 0 : _a59.play());
  ...
  function syncLocalHostVu() {
    ...
    const track = (_a59 = media == null ? void 0 : media.getLocalAudioTrack) == null ? void 0 : _a59.call(media);
    if (!track || track.readyState !== "live") return;
  ...
  function mergeLastAudioSourcesFromEstado(payload = {}) {
    var _a59;
    if ((_a59 = payload.audioSources) == null ? void 0 : _a59.length) {
  ...
  async function syncHostAudioMonitor(sources = null) {
    ...
    syncAudioMonitorPromise = (async () => {
      ...
      do {
        ...
        if (!monitor) return;
        monitor.setMasterVolume(Number(((_a59 = els.volumeSlider) == null ? void 0 : _a59.value) || 100) / 100);
  ...
  function closeFsSourceMenu() {
    ...
    (_a59 = els.btnFsSources) == null ? void 0 : _a59.setAttribute("aria-expanded", "false");
  }
  function toggleFsSourceMenu() {
    ...
    (_a59 = els.btnFsSources) == null ? void 0 : _a59.setAttribute("aria-expanded", String(open));
  }
  ...
  function renderLista() {
    ...
    ui.set({
      ...
      isPaused: !!((_a59 = estado.selecionado) == null ? void 0 : _a59.pausado)
    });
  ...
  async function runTransmission(raw, gen = transmissionGeneration) {
    var _a59, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s;
    ...
    if (tx.selectedPeerId) {
      ...
      if (client) {
        estado.selecionado = {
          ...
          producerIds: {
            ...client.producerIds || {},
            video: ((_a59 = tx.producerIds) == null ? void 0 : _a59.video) || ((_b = client.producerIds) == null ? void 0 : _b.video) || client.producerId || null
          },
  ...
  function shouldHostApplyActiveVideo(tx) {
    var _a59, _b, _c, _d;
    const activeKey = activeVideoTransmissionKey(tx);
    const currentProducerId = (media == null ? void 0 : media.currentActiveVideoProducerId) || ((_b = (_a59 = media == null ? void 0 : media.remoteConsumers) == null ? void 0 : _a59.video) == null ? void 0 : _b.producerId) || null;
  ...
  async function applyRoomSnapshot(snapshot, { force = false } = {}) {
    ...
    debugHostLog("H1", "[ROOM_STATE] snapshot recebido", {
      activeKey,
      producerVideo: ((_c = (_b = (_a59 = parsed.transmission) == null ? void 0 : _a59.producerIds) == null ? void 0 : _b.video) == null ? void 0 : _c.slice(0, 8)) || null,
  ...
  function applyVolumeFromSlider() {
    var _a59;
    const vol = Number(((_a59 = els.volumeSlider) == null ? void 0 : _a59.value) || 100) / 100;
  ...
  function stopRecordingCapture() {
    var _a59;
    (_a59 = recordingCapture == null ? void 0 : recordingCapture.stop) == null ? void 0 : _a59.call(recordingCapture);
    recordingCapture = null;
  }
  function getActiveRecordingSelection() {
    var _a59, _b, _c, _d, _e, _f;
    if ((_a59 = estado.selecionado) == null ? void 0 : _a59.id) return estado.selecionado;
  ...
  async function getRecordingStream() {
    ...
    const videoTrack = (_b = (_a59 = compositor == null ? void 0 : compositor.stream) == null ? void 0 : _a59.getVideoTracks) == null ? void 0 : _b.call(_a59)[0];
    ...
    recordingCapture = {
      ...
      stop() {
        var _a60;
        compositor.stop();
        (_a60 = mixer == null ? void 0 : mixer.stop) == null ? void 0 : _a60.call(mixer);
      }
    };
    return stream;
  }
  function handleMessage(msg) {
    var _a59, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p;
    if (msg.type === "estadoSala") {
      applyRoomSnapshot(msg.payload).catch((e) => errors.handle(e, "estado-sala"));
      return;
    }
    if (msg.type === "clientesSilenciados") {
      const mutedIds = ((_a59 = msg.payload) == null ? void 0 : _a59.mutedPeerIds) || [];
      mutedClients.clear();
    ...
    if (msg.type === "estado") {
      ...
      const videoProducers = (estado.clients || []).filter((c) => {
        var _a60;
        return c.hasVideo || c.isProducing || ((_a60 = c.producerIds) == null ? void 0 : _a60.video);
      }).map((c) => {
        var _a60, _b2, _c2, _d2;
        return {
          peerId: (_a60 = c.id) == null ? void 0 : _a60.slice(0, 8),
      ...
      renderLista();
      syncHostAudioMonitor(((_c = (_b = msg.payload) == null ? void 0 : _b.audioSources) == null ? void 0 : _c.length) ? msg.payload.audioSources : null).catch(
        (e) => errors.handle(e, "audio-monitor")
      );
    }
    if (msg.type === "demovidoCoHost") {
      if (isCoHostInstance) {
        ...
        (_d = els.appMain) == null ? void 0 : _d.classList.remove("sidebar-open");
        (_e = els.appMain) == null ? void 0 : _e.classList.remove("sidebar-collapsed");
        (_f = els.sidebar) == null ? void 0 : _f.classList.remove("is-collapsed");
    ...
    if (msg.type === "fontesAudio") {
      const sources = ((_g = msg.payload) == null ? void 0 : _g.sources) || [];
      lastAudioSources = sources;
    ...
    if (msg.type === "consumerFechado") {
      ...
      const wasVideoConsumer = ((_j = (_i = media == null ? void 0 : media.remoteConsumers) == null ? void 0 : _i.video) == null ? void 0 : _j.id) === consumerId;
      if (consumerId) {
    ...
    if (msg.type === "erro") {
      const text = String(((_n = msg.payload) == null ? void 0 : _n.mensagem) || "").toLowerCase();
      const benign = joinInProgress || text.includes("nao autenticado") || text.includes("nao autenticado");
      if (benign) {
        log(((_o = msg.payload) == null ? void 0 : _o.mensagem) || "Erro transitorio", "warn");
        return;
      }
      errors.handle(new Error((_p = msg.payload) == null ? void 0 : _p.mensagem), "servidor");
    }
  }
...
${entry.technical}`;
  ...
  (_a10 = els.btnPlayPause) == null ? void 0 : _a10.addEventListener("click", () => {
    ...
    if (ui._flags.isPaused) {
      (_a59 = els.btnRetomar) == null ? void 0 : _a59.click();
    } else {
  ...
  function toggleSidebarCollapsed() {
    var _a59, _b, _c, _d, _e, _f;
    const collapsed = !((_a59 = els.sidebar) == null ? void 0 : _a59.classList.contains("is-collapsed"));
  ...
  function openExternalLinkModal() {
    ...
    (_a59 = els.externalGuestName) == null ? void 0 : _a59.focus();
  }
  ...
  async function submitExternalLink() {
    var _a59, _b;
    const nome = ((_a59 = els.externalGuestName) == null ? void 0 : _a59.value.trim()) || "";
    if (!nome) {
      showToast2("Informe o nome do convidado", "warn");
  ...
  (_a23 = els.btnFullscreen) == null ? void 0 : _a23.addEventListener("click", () => {
    ...
    else (_b = (_a59 = els.previewArea) == null ? void 0 : _a59.requestFullscreen) == null ? void 0 : _b.call(_a59);
  });
  var _a24;
  ...
  document.addEventListener("click", (e) => {
    var _a59, _b, _c;
    if ((_a59 = els.fsSourceMenu) == null ? void 0 : _a59.hidden) return;
  ...
  window.addEventListener("sharescreen-ended", async () => {
    ...
    signaling == null ? void 0 : signaling.send("status", {
      status: ((_a59 = media == null ? void 0 : media.hasPublishedMicrophone) == null ? void 0 : _a59.call(media)) ? "transmitindo" : "conectado"
    });
  });
  window.addEventListener("beforeunload", () => {
    clearInterval(hostLockTimer);
  ...
  function setupRecordingAudioPrefs() {
    ...
    syncRecordingAudioPrefsUi();
    syncRecordingDefaultAudioClientUi();
    (_a59 = els.recExcludeOwnSystem) == null ? void 0 : _a59.addEventListener("change", () => {
    ...
    (_c = els.btnRecMeetBridgePreset) == null ? void 0 : _c.addEventListener("click", () => {
    ...
    (_d = els.btnRecClearDefaultAudio) == null ? void 0 : _d.addEventListener("click", () => {
      setDefaultRecordingAudioClientName("");
      showToast2("\xC1udio padr\xE3o da grava\xE7\xE3o removido", "info");
      renderLista();
    });
  ...
  function saveRecordingFilenamePattern() {
    var _a59;
    const pattern = ((_a59 = els.recordingFilenamePatternInput) == null ? void 0 : _a59.value.trim()) || "";
    if (pattern) {
  ...
  function setupRecordingFilenamePattern() {
    ...
    (_a59 = els.btnSaveFilenamePattern) == null ? void 0 : _a59.addEventListener("click", (e) => {
      e.stopPropagation();
  ...
  function setupRecordingsDirInput() {
    ...
    (_a59 = document.getElementById("btn-dir-picker-cancel")) == null ? void 0 : _a59.addEventListener("click", () => {
  ...
  if (isHost) {
    ...
    installAudioUnlock(() => {
      ...
      (_b = (_a59 = els.previewAudio) == null ? void 0 : _a59.play) == null ? void 0 : _b.call(_a59).catch(() => {
      });
  ...
  async function syncPublishedAudioFiltersToClientsAsync(audioSources = []) {
    ...
    for (const source of audioSources || []) {
      ...
      const displayName2 = (client == null ? void 0 : client.displayName) || source.name || ((_b = (_a59 = monitor.peerNames) == null ? void 0 : _a59.get) == null ? void 0 : _b.call(_a59, id)) || "";
  ...
  function applyAudioFiltersFromUi() {
    ...
    const prefs = {
      gain: Number(((_a59 = $("audio-gain")) == null ? void 0 : _a59.value) !== void 0 ? (_b = $("audio-gain")) == null ? void 0 : _b.value : 1),
  ...
  async function ensureClientAudioFilterPresetLoaded(client) {
    if (!(client == null ? void 0 : client.id) || !(client == null ? void 0 : client.displayName)) return;
    const monitor = hostAudioMonitor;
    if (!monitor) return;
  ...
  var _a32;
  (_a32 = $("audio-hp-enabled")) == null ? void 0 : _a32.addEventListener("change", applyAudioFiltersFromUi);
  var _a33;
  ...
  var _a34;
  (_a34 = $("audio-peak-enabled")) == null ? void 0 : _a34.addEventListener("change", applyAudioFiltersFromUi);
  var _a35;
  ...
  var _a37;
  (_a37 = $("audio-comp-enabled")) == null ? void 0 : _a37.addEventListener("change", applyAudioFiltersFromUi);
  var _a38;
  (_a38 = $("audio-gate-enabled")) == null ? void 0 : _a38.addEventListener("change", applyAudioFiltersFromUi);
  var _a39;
  (_a39 = $("audio-gate-threshold")) == null ? void 0 : _a39.addEventListener("input", (e) => {
    const el = $("audio-gate-thresh-val");
    if (el) el.textContent = `${e.target.value} dB`;
    applyAudioFiltersFromUi();
  });
  var _a40;
  (_a40 = $("audio-capture-distance")) == null ? void 0 : _a40.addEventListener("input", (e) => {
    const el = $("audio-capture-distance-val");
    if (el) el.textContent = `${e.target.value}/10`;
    applyAudioFiltersFromUi();
  });
  var _a41;
  (_a41 = $("btn-audio-filters-reset")) == null ? void 0 : _a41.addEventListener("click", () => {
    const client = activeAudioFiltersClient;
    if (!client) return;
  ...
  var _a42;
  (_a42 = $("ctx-audio")) == null ? void 0 : _a42.addEventListener("click", () => {
    const client = activeContextClient;
    closeContextMenu();
    if (client) openAudioFiltersModal(client);
  });
  var _a43;
  (_a43 = $("ctx-rec-audio")) == null ? void 0 : _a43.addEventListener("click", () => {
    const client = activeContextClient;
    closeContextMenu();
    if (client) toggleDefaultRecordingAudioClient(client);
  });
  var _a44;
  (_a44 = $("btn-audio-filters-cancel")) == null ? void 0 : _a44.addEventListener("click", () => closeAudioFiltersModal(true));
  var _a45;
  (_a45 = $("btn-audio-filters-save")) == null ? void 0 : _a45.addEventListener("click", saveAudioFiltersModal);
  document.addEventListener("click", (e) => {
    const menu = $("custom-context-menu");
    if (menu && !menu.hidden) {
  ...
  function initCoHost(clientSignaling, clientMedia, clientPeerId) {
    ...
    hostReady = true;
    if (els.sidebar) els.sidebar.hidden = false;
    (_a59 = els.appMain) == null ? void 0 : _a59.classList.add("sidebar-open");
    updateRecordingUi(RecordingState.IDLE);
    updateMuteButtonIcon();
    setupRecordingsDirInput();
    setupRecordingFilenamePattern();
  ...
  var _a46;
  (_a46 = els2.micSelect) == null ? void 0 : _a46.addEventListener("change", () => {
    saveCapturePrefs(getCapturePrefsFromUi());
    releaseClientMicTrack();
    attachVuMeterIfNeeded();
  });
  var _a47;
  (_a47 = els2.chkMicrophone) == null ? void 0 : _a47.addEventListener("change", () => {
    var _a59;
    saveCapturePrefs(getCapturePrefsFromUi());
    if (!((_a59 = els2.chkMicrophone) == null ? void 0 : _a59.checked)) releaseClientMicTrack();
    updateClientMicUi();
    attachVuMeterIfNeeded();
  });
  var _a48;
  (_a48 = els2.chkSystemAudio) == null ? void 0 : _a48.addEventListener("change", () => saveCapturePrefs(getCapturePrefsFromUi()));
  setupMicrophonePicker({
  ...
  function updateClientMicUi() {
    ...
    if (!btn) return;
    const micPublished = (_a59 = media2 == null ? void 0 : media2.hasPublishedMicrophone) == null ? void 0 : _a59.call(media2);
  ...
  async function onClientMicClick() {
    ...
    try {
      if (clientMicAutoplayNeeded) {
        ...
        await ((_a59 = els2.audio) == null ? void 0 : _a59.play());
  ...
  function saveSettingsModal() {
    ...
    const newName = (_b = (_a59 = els2.settingsNomeInput) == null ? void 0 : _a59.value) == null ? void 0 : _b.trim();
    if (newName) {
      displayName = newName;
  ...
  function expectedHostSourceCount() {
    if (!hostPeerId2) return 0;
    return normalizeRemoteAudioSources(lastAudioSources2, { excludePeerId: peerId }).filter(
      (s) => String(s.peerId) === String(hostPeerId2)
    ).length;
  }
  function applyHostPeerFromSnapshot(parsed = {}) {
    var _a59, _b;
    const nextHostId = ((_a59 = parsed.host) == null ? void 0 : _a59.id) || null;
    if (nextHostId) {
  ...
  async function repairHostAudioIfNeeded() {
    var _a59, _b, _c;
    if (!hostPeerId2 || !media2 || !sessionReady) return;
    const monitor = ensureClientAudioMonitor();
    if (!monitor) return;
    const expected = expectedHostSourceCount();
    if (!expected) return;
    const active = ((_a59 = monitor.countLiveChannelsForPeer) == null ? void 0 : _a59.call(monitor, hostPeerId2)) ?? 0;
    if (active >= expected) return;
    monitor.setPinnedPeerIds([hostPeerId2]);
    audioTrace("audio-health", {
      event: "repair-host",
      hostPeerId: hostPeerId2.slice(0, 8),
      expected,
      active
    });
    ...
    for (const delay of backoffs) {
      ...
      await monitor.syncPeerSources(hostPeerId2, lastAudioSources2);
      if ((((_b = monitor.countLiveChannelsForPeer) == null ? void 0 : _b.call(monitor, hostPeerId2)) ?? 0) >= expected) break;
    }
  ...
  function startAudioHealthWatchdog() {
    ...
    audioHealthTimer = setInterval(() => {
      var _a59;
      if (!sessionReady || !hostPeerId2) return;
      const expected = expectedHostSourceCount();
      if (!expected) return;
      const monitor = roomAudioMonitor;
      const active = ((_a59 = monitor == null ? void 0 : monitor.countLiveChannelsForPeer) == null ? void 0 : _a59.call(monitor, hostPeerId2)) ?? 0;
      if (active < expected) {
      ...
      do {
        ...
        while (list.length && monitor.channelCount === 0 && retryCycle < retryBackoffs.length) {
          ...
          await monitor.syncFromSources(
            normalizeRemoteAudioSources(lastAudioSources2, { excludePeerId: peerId })
          );
        }
        monitor.connectOutput(els2.audio);
        await monitor.resume();
        if (((_a59 = monitor.isAutoplayBlocked) == null ? void 0 : _a59.call(monitor)) || monitor.channelCount > 0 && ((_b = els2.audio) == null ? void 0 : _b.paused)) {
          onRemoteAudioAutoplayBlocked();
        } else if (!monitor.channelCount) {
          clientMicAutoplayNeeded = false;
          updateClientMicUi();
  ...
  async function ensureClientMicTrack(deviceId = "") {
    ...
    if ((clientMicTrack == null ? void 0 : clientMicTrack.readyState) === "live") {
      const activeId = ((_a59 = clientMicTrack.getSettings) == null ? void 0 : _a59.call(clientMicTrack).deviceId) || "";
  ...
  async function teardownClientSession({ keepDisplayStream = false, keepMicTrack = false } = {}) {
    ...
    if (!keepDisplayStream) {
      (_a59 = clientDisplayStream == null ? void 0 : clientDisplayStream.getTracks) == null ? void 0 : _a59.call(clientDisplayStream).forEach((t) => t.stop());
  ...
  function hasPendingDisplayStream() {
    var _a59;
    return (_a59 = clientDisplayStream == null ? void 0 : clientDisplayStream.getVideoTracks) == null ? void 0 : _a59.call(clientDisplayStream).some((t) => t.readyState === "live");
  }
  ...
  async function captureScreenFirst() {
    var _a59;
    if (!((_a59 = media2 == null ? void 0 : media2.hasVideoProducer) == null ? void 0 : _a59.call(media2))) {
...
Detalhe: ${technical}` : msg;
  ...
  function getNome() {
    var _a59;
    return (((_a59 = els2.nomeInput) == null ? void 0 : _a59.value) || displayName || "").trim();
  }
  ...
  async function initOnboarding() {
    ...
    if (hasExternalAccessToken) {
      ...
      showIdentifyStep();
      (_a59 = els2.nomeInput) == null ? void 0 : _a59.focus();
      return;
    }
    if (autoViewerEntry) {
  ...
  var _a49;
  (_a49 = els2.btnSalvarNome) == null ? void 0 : _a49.addEventListener("click", () => salvarEIniciar(false));
  var _a50;
  (_a50 = els2.btnViewerEnter) == null ? void 0 : _a50.addEventListener("click", () => salvarEIniciar(true));
  var _a51;
  (_a51 = els2.nomeInput) == null ? void 0 : _a51.addEventListener("keydown", (e) => {
    var _a59;
    if (e.key === "Enter") {
      e.preventDefault();
      salvarEIniciar(!!((_a59 = els2.chkViewerOnly) == null ? void 0 : _a59.checked));
    }
  });
  var _a52;
  (_a52 = els2.btnEditarNome) == null ? void 0 : _a52.addEventListener("click", () => {
    if (els2.nomeInput) els2.nomeInput.value = displayName;
    showOverlay();
  });
  async function attachVuMeterIfNeeded() {
    var _a59, _b, _c;
    vu.detach();
    if (!((_a59 = els2.chkMicrophone) == null ? void 0 : _a59.checked)) return;
    try {
  ...
  async function applyRoomSnapshot2(snapshot, { force = false } = {}) {
    ...
    if ((_a59 = parsed.audioSources) == null ? void 0 : _a59.length) {
  ...
  async function rejoinSession() {
    ...
    try {
      ...
      const stream = ((_a59 = clientDisplayStream == null ? void 0 : clientDisplayStream.getVideoTracks) == null ? void 0 : _a59.call(clientDisplayStream).some((t) => t.readyState === "live")) ? clientDisplayStream : ((_c = (_b = media2 == null ? void 0 : media2.localScreenStream) == null ? void 0 : _b.getVideoTracks) == null ? void 0 : _c.call(_b).some((t) => t.readyState === "live")) ? media2.localScreenStream : null;
      await (roomAudioMonitor == null ? void 0 : roomAudioMonitor.dispose());
      roomAudioMonitor = null;
      await (media2 == null ? void 0 : media2.dispose({
  ...
  function closeFsSourceMenu2() {
    ...
    (_a59 = els2.btnFsSources) == null ? void 0 : _a59.setAttribute("aria-expanded", "false");
  }
  function toggleFsSourceMenu2() {
    ...
    (_a59 = els2.btnFsSources) == null ? void 0 : _a59.setAttribute("aria-expanded", String(open));
  }
  ...
  async function handleServerMessage(msg) {
    ...
    if (msg.type === "filtroAudioAtualizado") {
      pendingMicrophoneFilterPrefs = ((_a59 = msg.payload) == null ? void 0 : _a59.prefs) || {};
      if (media2) {
  ...
  var _a53;
  (_a53 = els2.btnSettings) == null ? void 0 : _a53.addEventListener("click", () => openSettingsModal());
  var _a54;
  (_a54 = els2.btnSettingsSave) == null ? void 0 : _a54.addEventListener("click", () => saveSettingsModal());
  var _a55;
  (_a55 = els2.btnSettingsClose) == null ? void 0 : _a55.addEventListener("click", () => closeSettingsModal());
  var _a56;
  (_a56 = els2.btnClientMic) == null ? void 0 : _a56.addEventListener("click", () => onClientMicClick());
  var _a57;
  (_a57 = els2.btnFullscreen) == null ? void 0 : _a57.addEventListener("click", () => {
    var _a59;
    const el = els2.clientMain || document.querySelector(".client-main");
    if (document.fullscreenElement) document.exitFullscreen();
    else (_a59 = el == null ? void 0 : el.requestFullscreen) == null ? void 0 : _a59.call(el);
  });
  var _a58;
  (_a58 = els2.btnFsSources) == null ? void 0 : _a58.addEventListener("click", (e) => {
    e.stopPropagation();
    toggleFsSourceMenu2();
  });
  ...
  document.addEventListener("click", (e) => {
    var _a59, _b, _c;
    if ((_a59 = els2.fsSourceMenu) == null ? void 0 : _a59.hidden) return;
  ...
  window.addEventListener("sharescreen-ended", async () => {
    ...
    onboardStep = "identify";
    updateClientMicUi();
    const micActive = (_a59 = media2 == null ? void 0 : media2.hasPublishedMicrophone) == null ? void 0 : _a59.call(media2);
  ...
  installAudioUnlock(() => {
    ...
    (_b = (_a59 = els2.audio) == null ? void 0 : _a59.play) == null ? void 0 : _b.call(_a59).catch(() => {
    });

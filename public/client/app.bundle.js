...
${entry.technical}`;
  ...
  var _a38;
  (_a38 = $("audio-sensitivity-enabled")) == null ? void 0 : _a38.addEventListener("change", applyAudioFiltersFromUi);
  var _a39;
  (_a39 = $("audio-gate-enabled")) == null ? void 0 : _a39.addEventListener("change", applyAudioFiltersFromUi);
  var _a40;
  ...
  function expectedAudioSourceCount() {
    return normalizeRemoteAudioSources(lastAudioSources2, { excludePeerId: peerId }).length;
  }
  ...
  async function repairAllAudioIfNeeded() {
    ...
    const list = normalizeRemoteAudioSources(lastAudioSources2, { excludePeerId: peerId });
    const backoffs = [0, 400, 800, 1600];
    for (const delay of backoffs) {
      if (delay) await new Promise((r) => setTimeout(r, delay));
      await monitor.syncFromSources(list);
...
Detalhe: ${technical}` : msg;
  ...
  async function handleServerMessage(msg) {
    ...
    if (msg.type === "filtroAudioAtualizado") {
      pendingMicrophoneFilterPrefs = ((_a60 = msg.payload) == null ? void 0 : _a60.prefs) || {};
      if (media2) {
